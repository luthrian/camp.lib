...
public class OldTableAttribute extends ProductAttributeDefinition<CampOldTable<ProductAttributeDefinition<?,?>>,CampTable<CampType<?>>> {

	public OldTableAttribute(String name, String type, CampOldTable<ProductAttributeDefinition<?,?>> value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public OldTableAttribute(String name, String type, CampOldTable<ProductAttributeDefinition<?,?>> value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public OldTableAttribute(int id, String name, String type, CampOldTable<ProductAttributeDefinition<?,?>> value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	@SuppressWarnings("unchecked")
	public static OldTableAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		OldTableAttribute ea = new OldTableAttribute(pa.name(),pa.type(),(CampOldTable<ProductAttributeDefinition<?,?>>)pa.value());
		ea.updateId(pa.id());
