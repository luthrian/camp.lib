...
public class ComplexAttribute extends ProductAttributeDefinition<CampOldComplex<ProductAttributeDefinition<?,?>>,CampComplex<CampType<?>>> {

	public ComplexAttribute(String name, String type, CampOldComplex<ProductAttributeDefinition<?,?>> value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public ComplexAttribute(String name, String type, CampOldComplex<ProductAttributeDefinition<?,?>> value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public ComplexAttribute(int id, String name, String type, CampOldComplex<ProductAttributeDefinition<?,?>> value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	@SuppressWarnings("unchecked")
	public static ComplexAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		ComplexAttribute ea = new ComplexAttribute(pa.name(),pa.type(),(CampOldComplex<ProductAttributeDefinition<?,?>>)pa.value());
		ea.updateId(pa.id());
	...
	public AttributeList toList() {
		AttributeList al = new AttributeList();
		for(String key:this.value().keySet()) {
			al.addAll(this.value().get(key));
		}
		return al;
	}
	
//	public final static ComplexAttribute fromList(AttributeList list){
//		String productGroup = list.get(0).productGroup();
//		ComplexAttribute complex = new ComplexAttribute();
