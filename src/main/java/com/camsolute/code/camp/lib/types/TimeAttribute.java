...
import com.camsolute.code.camp.core.types.CampTime;
...
public class TimeAttribute extends ProductAttributeDefinition<DateTime,CampTime> {

	public TimeAttribute(String name, String type, DateTime value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public TimeAttribute(String name, String type, DateTime value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public TimeAttribute(int id, String name, String type, DateTime value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public static TimeAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		TimeAttribute ea = new TimeAttribute(pa.name(),pa.type(),(DateTime)pa.value());
		ea.updateId(pa.id());
