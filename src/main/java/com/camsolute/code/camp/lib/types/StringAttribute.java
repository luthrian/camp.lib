...
import com.camsolute.code.camp.core.types.CampString;
...
public class StringAttribute extends ProductAttributeDefinition<String,CampString> {

	public StringAttribute(String name, String type, String value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public StringAttribute(String name, String type, String value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public StringAttribute(int id, String name, String type, String value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public static StringAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		StringAttribute ea = new StringAttribute(pa.name(),pa.type(),(String)pa.value());
		ea.updateId(pa.id());
