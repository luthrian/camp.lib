...
public class ListAttribute extends ProductAttributeDefinition<CampList<CampType<?>>,CampList<CampType<?>>> {

	public ListAttribute(String name, String type, CampList<CampType<?>> value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public ListAttribute(String name, String type, CampList<CampType<?>> value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public ListAttribute(int id, String name, String type, CampList<CampType<?>> value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	@SuppressWarnings("unchecked")
	public static ListAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		ListAttribute ea = new ListAttribute(pa.name(),pa.type(),(CampList<CampType<?>>)pa.value());
		ea.updateId(pa.id());
