...
import com.camsolute.code.camp.core.types.CampInteger;
...
public class IntegerAttribute extends ProductAttributeDefinition<Integer,CampInteger> {

	public IntegerAttribute(String name, String type, Integer value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public IntegerAttribute(String name, String type, Integer value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public IntegerAttribute(int id, String name, String type, Integer value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public static IntegerAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		IntegerAttribute ea = new IntegerAttribute(pa.name(),pa.type(),(Integer)pa.value());
		ea.updateId(pa.id());
