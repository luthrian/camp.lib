...
public class OrderPositionProcess extends Process<OrderPosition> implements OrderPositionProcessInterface  {
	...
	public OrderPositionProcess(int id, String instanceId, String businessKey, String processName, String definitionId, String tenantId, String caseInstanceId, boolean ended, boolean suspended, ProcessType type) {
