...
import com.camsolute.code.camp.core.types.CampText;
...
public class TextAttribute extends ProductAttributeDefinition<String,CampText> {

	public TextAttribute(String name, String type, String value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public TextAttribute(String name, String type, String value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public TextAttribute(int id, String name, String type, String value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public static TextAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		TextAttribute ea = new TextAttribute(pa.name(),pa.type(),(String)pa.value());
		ea.updateId(pa.id());
