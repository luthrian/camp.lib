...
public class ProductDefinition extends Product {
	...
	public ProductDefinition(String name, String businessKey, Group group, Version version, Timestamp date) {
		super(name, businessKey, group, version, date);
		// TODO Auto-generated constructor stub
	}

	public ProductDefinition(int id, String name, String businessKey, Group group, Version version, Timestamp date) {
