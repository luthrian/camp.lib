...
import com.camsolute.code.camp.core.types.CampDate;
...
public class DateAttribute extends ProductAttributeDefinition<DateTime,CampDate> {

	public DateAttribute(String name, String type, DateTime value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public DateAttribute(String name, String type, DateTime value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public DateAttribute(int id, String name, String type, DateTime value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public static DateAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		DateAttribute ea = new DateAttribute(pa.name(),pa.type(),(DateTime)pa.value());
		ea.updateId(pa.id());
