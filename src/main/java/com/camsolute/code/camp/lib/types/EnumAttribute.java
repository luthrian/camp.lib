...
import com.camsolute.code.camp.core.types.CampEnum;
...
public class EnumAttribute extends ProductAttributeDefinition<CampEnum,CampEnum> {

	public EnumAttribute(String name, String type, CampEnum value) {
		super(name, type, value);
		// TODO Auto-generated constructor stub
	}

	public EnumAttribute(String name, String type, CampEnum value, Version version, Group group) {
		super(name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public EnumAttribute(int id, String name, String type, CampEnum value, Version version, Group group) {
		super(id, name, type, value, version, group);
		// TODO Auto-generated constructor stub
	}

	public static EnumAttribute fromProductAttribute(ProductAttributeDefinition<?,?> pa) {
		EnumAttribute ea = new EnumAttribute(pa.name(),pa.type(),(CampEnum)pa.value());
		ea.updateId(pa.id());
